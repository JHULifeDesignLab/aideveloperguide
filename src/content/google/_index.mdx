...
<div className="flex justify-center mt-8">
  <a href="/developerguide/google/step-1" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200 no-underline">
