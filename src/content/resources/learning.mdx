...
- [Appendix A: Sample Project Ideas](#appendix-a-sample-project-ideas)
  - [Documentation Tips](#documentation-tips)
- [Appendix B: Courses, Tools & Communities](#appendix-b-courses-tools--communities)

<div id="final-tips-for-success">
...
<div id="appendix-a-sample-project-ideas">
...
**Tutorial:** [Google Codelab on Text Summarization with Vertex AI](https://codelabs.developers.google.com/vertex-ai-summarization) walks you through multiple methods (like "MapReduce") to generate concise summaries from large documents.
</details>
