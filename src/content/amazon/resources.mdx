...
<div className="flex justify-between items-center mb-8">
  <a href="/amazon/step-3" className="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200">
    ← Previous: Step 3
  </a>
</div>le: "Amazon AWS AI Resources"
vendor: "amazon"
ordinal: 4
slug: "/amazon/resources"
lastReviewed: "2025-08-06"
